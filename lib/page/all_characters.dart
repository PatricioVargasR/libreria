...
class PersonajesParte extends StatefulWidget {
  const PersonajesParte({Key? key});

  @override
  State<PersonajesParte> createState() => _PersonajesParteState();
}

class _PersonajesParteState extends State<PersonajesParte> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Personajes", style: TextStyle(color: Colors.black)),
        centerTitle: true,
                  ...
                  child: Column(
                    children: [
                      ...
                      FutureBuilder<List<PersonajesModel>>(
                        future: PersonajeHttpService.obtenerTodosPersonaje(),
